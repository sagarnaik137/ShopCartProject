...
public class AdminPagesController {
	...
	public String add(@Valid Page page, BindingResult bindingResult, RedirectAttributes redirectAttributes,
		...
		if (slugExists != null) {
			redirectAttributes.addFlashAttribute("message", "slug already exist, please choose another");
	...
	@SuppressWarnings("deprecation")
	@PostMapping("/edit")
	public String delete(@Valid Page page, BindingResult bindingResult, RedirectAttributes redirectAttributes,
			Model model) {

		Page pageCurrent = pageRepository.getOne(page.getId());
		if (bindingResult.hasErrors()) {
			model.addAttribute("pageTitle", pageCurrent.getId());
			return "admin/pages/edit";
		}
